...
public class TemplateService {
	...
	public String getTemplate(UserDetails userDetails) throws Exception {
		String input = String.format(baseTemplate.getData(), baseTemplate.getEndpointDestination(),
				baseTemplate.getEndpointIssuer(), baseTemplate.getEndpointIssuer(), baseTemplate.getEndpointNameId(),
				userDetails.getUserName(), baseTemplate.getEndpointAudience(), userDetails.getMail(),
				userDetails.getFirstName(), userDetails.getLastName(), userDetails.getUserName(),
